...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    foreach ($books as &$book) {
        if ($book['id'] == $book_id && $book['copies'] > 0) {
            $book['copies']--;
            ...
            file_put_contents($borrow_file, json_encode($borrowed_books, JSON_PRETTY_PRINT));
    ...
    $message = $success ? "Book borrowed successfully!" : "Book not available!";
}
?>
